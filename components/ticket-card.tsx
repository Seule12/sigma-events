...
export default function TicketCard({
  ...
  return (
    ...
    >
      ...
      >
        <p className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-white/70">
          <svg className="h-3.5 w-3.5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
          </svg>
          Sigma Security Bénin • Billet officiel
        </p>
      ...
      <div className="px-6 pb-5 pt-6">
        ...
        <div className="mt-4 flex items-center justify-center gap-2 rounded-xl bg-emerald-50 px-3 py-2.5">
          ...
          <p className="text-center text-[10px] font-extrabold uppercase tracking-wide text-emerald-800">
            Pass d&apos;accès authentifié et sécurisé par Sigma Security Bénin
          </p>
        </div>
